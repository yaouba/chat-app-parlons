...
const PREVIEW_MESSAGES = [
  ...
  { id: 2, text: 'I am good, thank you!', isSent: true },
];
        ...
        <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-4">
          {THEMES.map((t) => (
            <button
              key={t}
              className={`
                group flex flex-col items-center gap-1.5 rounded-lg transistion-colors
          ...
          <div className="p-4 bg-base-200">
            <div className="max-w-lg mx-auto">
              ...
              <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                ...
                {/* Chat Messages */}
                <div className="p-4 space-y-4 min-h-[200px] max-[200px] overflow-y-auto bg-base-100">
